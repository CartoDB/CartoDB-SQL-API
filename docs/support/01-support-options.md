...
If you think you may have found a bug, or if you have a feature request that you would like to share with the SQL API team, please [open an issue](https://github.com/CartoDB/CartoDB-SQL-API/issues/new). 
